...
type CommonRequest struct {
	...
	Serialize uint32 `protobuf:"varint,3,opt,name=serialize,proto3" json:"serialize,omitempty"`
}
...
func (x *CommonRequest) GetRequest() string {
	if x != nil {
		return x.Request
	}
	return ""
...
func (x *CommonRequest) GetSerialize() uint32 {
	if x != nil {
		return x.Serialize
	}
	return 0
...
func (x *CommonResponse) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
var file_common_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22, 0x66, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x1c, 0x0a, 0x09, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x09, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x22, 0x44,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0x4a, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x39, 0x0a, 0x06, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x12,
	...
	0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_common_proto_goTypes = []interface{}{
	(*CommonRequest)(nil),  // 0: common.CommonRequest
	(*CommonResponse)(nil), // 1: common.CommonResponse
}
var file_common_proto_depIdxs = []int32{
	0, // 0: common.CommonService.handle:input_type -> common.CommonRequest
	1, // 1: common.CommonService.handle:output_type -> common.CommonResponse
...
type CommonServiceClient interface {
	// 基础Demo
	Handle(ctx context.Context, in *CommonRequest, opts ...grpc.CallOption) (*CommonResponse, error)
}
...
func (c *commonServiceClient) Handle(ctx context.Context, in *CommonRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	out := new(CommonResponse)
	err := c.cc.Invoke(ctx, "/common.CommonService/handle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommonServiceServer interface {
	// 基础Demo
	Handle(context.Context, *CommonRequest) (*CommonResponse, error)
}
...
func (*UnimplementedCommonServiceServer) Handle(context.Context, *CommonRequest) (*CommonResponse, error) {
...
func _CommonService_Handle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/common.CommonService/Handle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommonServiceServer).Handle(ctx, req.(*CommonRequest))
	}
